...
ширины и высоты, как при создании объекта, так и при установке их через
сеттеры."""
...
class Rectangle:
    ...
    def __setattr__(self, __name: str, __value: Any) -> None:
        if __name == 'width':
            text = f'Ширина должна быть положительной, а не {__value}'
        if __name == 'height':
            text = f'Высота должна быть положительной, а не {__value}'
        if __value < 0:
            raise NegativeValueError(text)
