...
указанием процентов вида 10.25%. В результате result получаем словарь
...
result = {names: salary*float(bonus[:-1])/100 for names, salary,
          bonus in zip(names, salary, bonus)}
print(result)
